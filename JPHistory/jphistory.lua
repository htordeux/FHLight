...
jps.listener.registerEvent("UNIT_SPELLCAST_START", function(unit,spellName,rank,lineId,spellId)
    jphistory.isCasting = true
end)
jps.listener.registerEvent("UNIT_SPELLCAST_FAILED", function(unit,spellName,rank,lineId,spellId)
    jphistory.isCasting = false
end)
...
function jphistory.createAllCastFrames()
    ...
    jphistory.frame:SetBackdropColor(0,0,0,0);
    ...
    jphistory.spellTitle:SetText("|cff1eff00Cast")
    ...
    jphistory.targetTitle:SetText("|cff1eff00Target")
    ...
    jphistory.currentTitle:SetText("|cff1eff00Current:")
    ...
    jphistory.lastTitle:SetText("|cff1eff00Last:")
...
function jphistory.updateTarget(target)
    if not jphistory.isCasting then
