	...
	function dk.updateRunes()
		...
		if(dk.dr1) then dk.runeCount = dk.runeCount+1 end
		if(dk.dr2) then dk.runeCount = dk.runeCount+1 end
		if(dk.ur1) then dk.runeCount = dk.runeCount+1 end
		if(dk.ur2) then dk.runeCount = dk.runeCount+1 end
		if(dk.fr1) then dk.runeCount = dk.runeCount+1 end
		if(dk.fr2) then dk.runeCount = dk.runeCount+1 end
