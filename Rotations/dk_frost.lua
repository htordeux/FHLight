...
local frostDWSpellTable = {
	...
	{ "plague strike",'jps.myDebuffDuration("Blood Plague") == 0 and dk.rune("oneUr")'},
	...
	{ "blood tap",'dk.getRunesReady() < 6 and jps.buffStacks("Blood Charge") >= 5 and jps.runicPower() > 20 and jps.buff("killing machine")'},
	...
	{ "plague strike",'jps.myDebuffDuration("Blood Plague") <= 3 and dk.rune("oneUr")'},
}
...
jps.registerRotation("DEATHKNIGHT","FROST",function()
	...
	spell,target = parseStaticSpellTable(frostDWSpellTable)
...
jps.registerStaticTable("DEATHKNIGHT","FROST",{
	...
	{ "blood tap",'dk.getRunesReady() < 6 and jps.buffStacks("Blood Charge") >= 5 and jps.buff("killing machine")'},
	{ "blood tap",'dk.getRunesReady() < 6 and jps.buffStacks("blood charge") >10 and jps.runicPower() > 76'},
	{ "frost strike",'jps.runicPower() > 76'},
	...
	{ "empower rune weapon",'IsSpellInRange("Obliterate","target") == 1 and jps.buff("Potion of Mogu Power") and not dk.rune("twoDr") and not dk.rune("twoUr") and not dk.rune("twoFr") and jps.runicPower() < 60 and jps.UseCDs'},
	{ "empower rune weapon",'IsSpellInRange("Obliterate","target") == 1 and jps.bloodlusting() and not dk.rune("twoDr") and not dk.rune("twoUr") and not dk.rune("twoFr") and jps.runicPower() < 60 and jps.UseCDs'},
	{ "blood tap",'dk.getRunesReady() < 6 and jps.buffStacks("blood charge")>10 and jps.runicPower()>=20'},
	{ "frost strike",'"onCD"'},
	{ "plague leech",'dk.canCastPlagueLeech(2)'},
	{ "empower rune weapon",'IsSpellInRange("Obliterate","target") == 1 and jps.targetIsRaidBoss() and jps.combatTime() < 35'}, -- so it will be ready at the end of most Raid fights
	{ "empower rune weapon",'IsSpellInRange("Obliterate","target") == 1 and jps.targetIsRaidBoss() and jps.hp("target") <= 0.35'}, -- soul reaper push
