...
spellTable = {
	...
	{ 152118, not jps.Moving and canHeal(myTank) and LowestImportantUnitHpct > 0.90 and AvgHealthLoss > 0.80 and ClarityFriendTarget(myTank) , myTank , "Timer_ClarityTank" },
