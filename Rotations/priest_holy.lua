...
local spellTable = {
	...
	{ "nested", not jps.Moving and CountInRange > 2 and AvgHealthRaid > 0.70 ,{
	...
	{ "nested", not jps.Moving ,{
		...
		{ spells.heal, jps.hp(TankThreat) < 0.90 and jps.FriendDamage(TankThreat) > 0 , TankThreat , "Soins_Tank_Damage"  },
