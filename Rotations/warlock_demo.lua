...
jps.registerRotation("WARLOCK","DEMONOLOGY",function()
	...
	local autoDispelMAgic = jps.canDispel("player",{"Magic"})
	...
	local spellTable = {
		...
		{ 108482, jps.cooldown(108482) == 0 and (playerIsStun or autoDispelMAgic and jps.Interrupts )	},				-- unStunt/dispell jps.Interrupts for on/off ---
