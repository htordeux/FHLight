...
function wlk.init()
	...
	jps.listener.registerEvent("PLAYER_REGEN_DISABLED", resetValues)
	jps.listener.registerEvent("PLAYER_REGEN_ENABLED", resetValues)
	jps.listener.registerEvent("PLAYER_UNGHOST", resetValues)
