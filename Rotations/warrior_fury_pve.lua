...
-- Cooldowns and Utility
		...
		{warrior.spells["BerserkerRage"],'jps.debuffDuration( 86346) > 0 and not jps.buff(18499,"player")', warrior.rangedTarget },
		{warrior.spells["Bloodbath"],'jps.UseCDs'},
...
-- AoE Rotation
		...
		{"nested", 'not jps.MultiTarget', {
			...
			{"nested", 'jps.myDebuff( 86346,"target")', {
				...
				{warrior.spells["HeroicLeap"],'onCD', warrior.rangedTarget}, 
				{warrior.spells["HeroicStrike"],'onCD', warrior.rangedTarget},
				-- "Raging Blow" 85288 "Coup déchaîné" -- buff Raging Blow! 131116
				{warrior.spells["RagingBlow"],'jps.buff(131116)', warrior.rangedTarget },
				-- "Bloodsurge" 46916 "Afflux sanguin"
				{warrior.spells["WildStrike"],'jps.buff(46916)', warrior.rangedTarget },
			}},
			{"nested", 'jps.Level >= 81', {
				{warrior.spells["ColossusSmash"],'jps.rage() >= warrior.relativeRage(0.75)', warrior.rangedTarget },
				{warrior.spells["Bloodthirst"],'onCD', warrior.rangedTarget },
				{warrior.spells["HeroicStrike"],'jps.rage() >= warrior.relativeRage(0.8)', warrior.rangedTarget },
				-- "Raging Blow" 85288 "Coup déchaîné" -- buff Raging Blow! 131116
				{warrior.spells["RagingBlow"],'jps.buffStacks(131116) == 2', warrior.rangedTarget },
				-- "Bloodsurge" 46916 "Afflux sanguin"
				{warrior.spells["WildStrike"],'jps.buff(46916)', warrior.rangedTarget },
				{warrior.spells["BattleShout"],'jps.rage() <= warrior.relativeRage(0.2) and jps.cooldown( 86346) < 3', "player" },
				{warrior.spells["ImpendingVictory"],'onCD', warrior.rangedTarget },
				{warrior.spells["HeroicThrow"],'onCD', warrior.rangedTarget },
			}},
			{"nested", 'jps.Level < 81', {
				{warrior.spells["Bloodthirst"],'onCD', warrior.rangedTarget },
				{warrior.spells["Execute"],'jps.hp("target") < 0.2', warrior.rangedTarget}, 
				...
				-- "Bloodsurge" 46916 "Afflux sanguin"
				{warrior.spells["WildStrike"],'jps.buff(46916)', warrior.rangedTarget },
				{warrior.spells["BattleShout"],'jps.rage() <= warrior.relativeRage(0.2)', "player" },
			}},
		}},
	}
