...
local spellTable = {
	...
	{ warrior.spells["ShieldSlam"] , inMelee and jps.buff(156291) and jps.buff(169667) , rangedTarget , "ShieldSlam_SwordBoard_Buff" },
	{ warrior.spells["ShieldSlam"] , inMelee and jps.buff(71) , rangedTarget , "ShieldSlam_SwordBoard_Buff" },
	
	-- DEFENSIVE BOSS DEBUFF
	{ warrior.spells["ShieldBlock"] , jps.buff(71) and jps.PhysicalDamage and not jps.buff(132404) and TankBossDebuff , rangedTarget , "|cff1eff00ShieldBlock_PhysicalDmg_TankBossDebuff" },
	{ warrior.spells["ShieldBarrier"] , jps.buff(71) and jps.MagicDamage and not jps.buff(112048) and TankBossDebuff , rangedTarget , "|cff1eff00ShieldBarrier_MagicDmg_TankBossDebuff" },
	-- DEFENSIVE HEALTH
	...
	-- "Execute" 5308 "Exécution" 
	{ warrior.spells["Execute"] , jps.hp(rangedTarget) < 0.20 and jps.rage() > 59 , rangedTarget , "Execute_Rage" },
